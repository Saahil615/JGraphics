public class Keys {
    ...
    public static final int VK_BACVK_QUOTE = 192;
    public static final int VK_BACVK_SLASH = 92;
    public static final int VK_BACVK_SPACE = 8;
    ...
    public static final int VK_INPUT_METHOD_ON_OF=    263;
